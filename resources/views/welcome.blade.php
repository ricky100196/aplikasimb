...
<body>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">APLIKASI TES IQ SISWA</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">PEMILIHAN JURUSAN DENGAN METODE CERTAINTY FACTOR</p>
              {{-- @guest
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="{{ route('login') }}" class="btn btn-outline-white">Login</a></p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="{{ route('register') }}" class="btn btn-outline-white">Register</a></p>
              @else
                <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500">
                    <a href="{{ route('admin') }}" class="btn btn-outline-white" > Hi {{ Auth::user()->name }} </a>
                </p>
             @endguest --}}
            </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h3 class="section-heading">Test IQ untuk Penentuan Jurusan</h3>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Pengenalan Diri</h3>
              <p>Untuk mengenal siapa dirimu</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Pengendalian Diri</h3>
              <p>Pengenalan diri untuk saran pengambilan keputusan</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Saran Jurusan</h3>
              <p>Analisa dan saran untuk penentuan jurusan</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="step">
              ...
              <h3>Daftar</h3>
              <p>Daftarkan diri anda untuk dapat mengenali diri anda</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="step">
              ...
              <h3>Profile</h3>
              <p>Lengkapi Profil data diri anda sebelum melakukan test</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="step">
              ...
              <h3>Test IQ</h3>
              <p>Lakukan Test Untuk Mendapatkan Saran</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-4 me-auto">
            <h2 class="mb-4">Mudah dan Bermanfaat</h2>
            <p class="mb-4">Aplikasi Mudah digunakan dan dapat dimanfaatkan sebagai saran pengambilan keputusan</p>
            <p><a href="#" class="btn btn-primary">Download Now</a></p>
          </div>
          <div class="col-md-6" data-aos="fade-left">
            <img src="{{ asset('Softland') }}/assets/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
  ...
  <!-- ======= Footer ======= -->
  <footer class="section cta-section" role="contentinfo">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12 me-auto text-center text-md-start mb-5 mb-md-3">
          <h2>Tentang Test IQ</h2>
          <p>Kecerdasan intelektual adalah istilah umum yang digunakan untuk menjelaskan sifat pikiran yang mencakup sejumlah kemampuan,
            seperti kemampuan menalar, merencanakan, setunbel memecahkan masalah, berpikir abstrak, memahami gagasan, menggunakan bahasa, daya tangkap, dan belajar.</p>
          {{-- <p class="social">
      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <p class="copyright">&copy; Copyright app test IQ. All Rights Reserved</p>
          <div class="credits">
            <!--
